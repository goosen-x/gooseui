...
import { BLOCK_CATEGORIES, type BlockCategory } from "@/lib/config/blocks-categories"
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const blockCategoryRoutes: MetadataRoute.Sitemap = BLOCK_CATEGORIES.map((category: BlockCategory) => ({
  ...
  const experimentalSection = docsNavigation.find((section: NavSection) => section.slug === "experimental")
