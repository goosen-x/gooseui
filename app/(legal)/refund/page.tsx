  ...
  return (
    <div className="container max-w-3xl py-16">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
        <section>
          <h2 className="text-xl font-semibold mt-8 mb-4">30-Day Money-Back Guarantee</h2>
          <p>
            We offer a <strong>30-day money-back guarantee</strong> on all paid subscriptions.
            If you&apos;re not satisfied with GooseUI for any reason, simply contact us within 30 days
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Exported content created during the subscription period remains yours</li>
          </ul>
        </section>

        <section>
          <h2 className="text-xl font-semibold mt-8 mb-4">Subscription Cancellation</h2>
          <p>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-2">
            ...
            <li>No partial refunds for unused time (unless within 30-day guarantee period)</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            Refunds are handled through Paddle&apos;s secure payment system.
          </p>
        </section>
