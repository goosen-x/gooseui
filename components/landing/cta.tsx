      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="relative z-10">
            ...
            >
              <span className="whitespace-nowrap">npx shadcn@latest add https://gooseui.pro/r/button.json</span>
            </div>
          ...
          <BorderBeam duration={10} colorFrom="#10b981" colorTo="#3b82f6" squircle />
        </div>
      </div>
    </section>
  )
