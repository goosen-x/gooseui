...
const footerLinks = {
  product: [
    { title: "Компоненты", href: "/docs/components/button" },
    { title: "Эффекты", href: "/docs/effects/border-beam" },
    { title: "Блоки", href: "/docs/blocks" },
  ],
  resources: [
      ...
      <div className="container py-12 md:py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Открытая библиотека компонентов для создания современных
        ...
        <div className="mt-12 pt-8 border-t flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} {siteConfig.name}. Открытый исходный код.
          </p>
