...
export const blocksMetadata: BlockMetadata[] = [
  ...
  // ===== HERO SECTIONS =====
  {
    ...
    category: "hero",
    name: "Classic Hero",
    description: "Hero with headline, CTA buttons, and side image placeholder",
    type: "file",
    iframeHeight: 650,
    isFeatured: true,
    isNew: true,
  },
  {
    ...
    category: "hero",
    name: "Split Hero",
    description: "Full-height split hero with content and browser mockup",
    type: "file",
    iframeHeight: 700,
    isNew: true,
  },
  ...
  // ===== BRANDS/LOGOS =====
  {
    ...
    description: "Infinite marquee of partner/client logos",
    type: "file",
    iframeHeight: 180,
    isFeatured: true,
    isNew: true,
  },
  {
    id: "brands-02",
    category: "brands",
    name: "Brands Double Row",
    description: "Double row marquee with opposite directions",
    type: "file",
    iframeHeight: 280,
    isNew: true,
  },
  ...
  // ===== SERVICES =====
  {
    ...
    description: "Infinite scroll of service cards with icons",
    type: "file",
    iframeHeight: 450,
    isFeatured: true,
    isNew: true,
  ...
  },
  {
    ...
    category: "services",
    name: "Services Bento",
    description: "Bento grid layout for services",
    type: "file",
    iframeHeight: 500,
    isComingSoon: true,
  },
